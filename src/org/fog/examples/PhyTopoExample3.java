...
public class PhyTopoExample3 {
	...
	private static void createPhysicalTopology(int userId, String appId, Application application) {
		...
		Switch dcSw = new Switch("DC_SW","geomap");
		Switch gwSw = new Switch("GW_SW","geomap");
		...
		for (int i = 0; i < NUM_EDGE_SW ; i++) {
			...
			Switch sw = new Switch("SW-"+i,"geomap");
			...
			Switch esw = new Switch("ESW-"+i,"geomap");
	...
	private static Application createApplication(String appId, int userId){
		 ...
		 */
		application.addAppModule("MODULE", 1000, 100,1);
